    ...
    <section className="auth-modal" role="dialog" aria-modal="true" aria-labelledby="auth-title">
      ...
      <div className="auth-form-wrap">
        ...
        <form onSubmit={submit}>
          ...
          <label className="auth-field"><span>Email address</span><div><Mail size={18} /><input required type="email" value={form.email} onChange={update('email')} placeholder="Your personal email" /></div></label>
